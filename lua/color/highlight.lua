...
function M.setup()
	...
	hmany({
		...
		{ "PmenuSbar", nil, c.one_bg3, nil, nil },
		...
		{ "CmpItemKindClass", c.yellow, nil, nil, nil },
		{ "CmpItemKindColor", c.pink, nil, nil, nil },
		{ "CmpItemKindConstant", c.yellow, nil, nil, nil },
		{ "CmpItemKindConstructor", c.cyan, nil, nil, nil },
		{ "CmpItemKindEnum", c.yellow, nil, nil, nil },
		{ "CmpItemKindEnumMember", c.yellow, nil, nil, nil },
		{ "CmpItemKindEvent", c.yellow, nil, nil, nil },
		{ "CmpItemKindField", c.yellow, nil, nil, nil },
		{ "CmpItemKindFile", c.yellow, nil, nil, nil },
		...
		{ "CmpItemKindModule", c.yellow, nil, nil, nil },
		{ "CmpItemKindOperator", c.yellow, nil, nil, nil },
		{ "CmpItemKindProperty", c.bright, nil, nil, nil },
		{ "CmpItemKindStruct", c.yellow, nil, nil, nil },
		{ "CmpItemKindText", c.blue, nil, nil, nil },
		{ "CmpItemKindTypeParameter", c.blue, nil, nil, nil },
		{ "CmpItemKindUnit", c.bright, nil, nil, nil },
		{ "CmpItemKindValue", c.blue, nil, nil, nil },
		{ "CmpItemKindVariable", c.blue, nil, nil, nil },
		-- misc

		-- inactive statuslines as thin lines
		{ "StatusLineNC", c.one_bg2, nil, "underline", nil },

		{ "LineNr", c.grey, nil, nil, nil },
		{ "NvimInternalError", c.red, nil, nil, nil },
		{ "VertSplit", c.one_bg3, nil, nil, nil },
		...
		{ "NvimTreeIndentMarker", c.one_bg3, nil, nil, nil },
